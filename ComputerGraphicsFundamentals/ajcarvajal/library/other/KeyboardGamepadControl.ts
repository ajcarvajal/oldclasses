...
namespace LibXOR {
    export const BUTTONA = 0;
    export const BUTTONB = 1;
    export const BUTTONX = 2;
    export const BUTTONY = 3;
    export const BUTTONLSHOULDER1 = 4;
    export const BUTTONRSHOULDER1 = 5;
    export const BUTTONLSHOULDER2 = 6;
    export const BUTTONRSHOULDER2 = 7;
    export const BUTTONSELECT = 8;
    export const BUTTONSTART = 9;
    export const BUTTONUP = 12;
    export const BUTTONDOWN = 13;
    export const BUTTONLEFT = 14;
    export const BUTTONRIGHT = 15;
    ...
    export class KeyboardGamepadControl {
